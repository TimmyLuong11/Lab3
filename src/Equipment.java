...
public class Equipment
{
    ...
    public Equipment(String strg)
    {
        ...
        this.count = Integer.parseInt(splitter[1]);
        this.totalWeight = Double.parseDouble(splitter[2]);
        this.totalPrice = Double.parseDouble(splitter[3]);
        this.description = splitter[4];
    }
